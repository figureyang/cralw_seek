 ...
 *
 * This class is used to get the detailed information of each job, and then write it in a CSV file
 */
public class Crawl_Details {
...
//                System.out.println();
                ...
                try
                {
                    ...
                    companyName = companyNameF.substring(0,companyNameF.indexOf("\n"));
                }
                catch (Exception e)
                {
                    try
                ...
                /**
                 * combinedDetails is the most important of the job, like job description or something
                 */
...
//                driver.quit();
             ...
             */
            String entry[] = {jobTitle, websiteURL, newJobtitle, companyName, location, email, phone, salary, JD, tagedDetails};
